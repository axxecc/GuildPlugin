...
public class EconomyManagementGUI implements GUI {
    ...
    private void openSetBalanceGUI(Player player, Guild guild) {
        // TODO: 实现设置资金GUI
        sendMessage(player, "&e设置资金功能开发中...");
        sendMessage(player, "&e使用命令: &f/guildadmin economy set " + guild.getName() + " <金额>");
    }

    private void openAddBalanceGUI(Player player, Guild guild) {
        // TODO: 实现增加资金GUI
        sendMessage(player, "&e增加资金功能开发中...");
        sendMessage(player, "&e使用命令: &f/guildadmin economy add " + guild.getName() + " <金额>");
    }

    private void openRemoveBalanceGUI(Player player, Guild guild) {
        // TODO: 实现减少资金GUI
        sendMessage(player, "&e减少资金功能开发中...");
        sendMessage(player, "&e使用命令: &f/guildadmin economy remove " + guild.getName() + " <金额>");
    }
